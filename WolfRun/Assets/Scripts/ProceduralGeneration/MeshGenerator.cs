...
public class MeshGenerator : MonoBehaviour
{
    ...
    public void GenerateMesh( int[ , ] map, float squareSize, /*added*/ Terrain terrain = null )
    {
        squareGrid = new SquareGrid( map, squareSize, terrain );
    ...
    public class SquareGrid
    {
        ...
        public SquareGrid( int[ , ] map, float squareSize, /*added*/ Terrain terrain = null )
        {
